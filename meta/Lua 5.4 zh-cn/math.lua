...
---返回 `y/x` 的反正切值（用弧度表示）。
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-math.atan>5.3"])
---
---@param y  number
---@param x? number
---@return number
...
---回以指定底的 `x` 的对数。
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-math.log>5.2"])
---
---@param x     number
---@param base? integer
---@return number
...
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-math.randomseed>5.4"])
---
---@param x? integer
---@param y? integer
