...
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-debug.getlocal<5.1"])
---
...
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-debug.getlocal>5.2"])
---
...
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-debug.getuservalue>5.4"])
---
---@param u userdata
---@param n integer
---@return any
...
---
---[查看文档](command:extension.lua.doc?["en-us/54/manual.html/pdf-debug.setuservalue>5.4"])
---
